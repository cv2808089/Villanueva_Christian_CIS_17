...
int *mode(const int *array,int arySize){
    ...
    // two for loops where the firsr pos is compared with the rest, then 2nd then 3rd...
    ...
    int *modeAry=new int[nmode+2];
    modeAry[0]=nmode;//Stub returns no modes
    modeAry[1]=maxc;//Stub returns Frequency 1
